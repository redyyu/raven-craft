...
local function onTrainingMechanics(playerObj, clothing, needle)
    ...
    ISTimedActionQueue.add(ISTrainingMechanicsAction:new(playerObj, clothing, needle))
end


local function doTrainingMechanicsMenu(player, context, items)
    ...
    if clothing then
        ...
        option = context:addOption(getText("ContextMenu_TRAIN_TAILORING"), playerObj, onTrainingMechanics, clothing, needle)
...
Events.OnFillInventoryObjectContextMenu.Add(doTrainingMechanicsMenu)