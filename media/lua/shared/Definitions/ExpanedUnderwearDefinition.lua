...
UnderwearDefinition.Female_Corset = {
    ...
    top = {
        ...
        {name=RC.getPackageItemType(".Corset_Pink"), chance=15},
        {name=RC.getPackageItemType(".Corset_BodysuitPink"), chance=10},
        {name=RC.getPackageItemType(".Corset_BodysuitBlack"), chance=10},
        {name=RC.getPackageItemType(".Corset_BodysuitRed"), chance=10},
        {name=RC.getPackageItemType(".Corset_BodysuitTINT"), chance=10},
        {name=RC.getPackageItemType(".Corset_ToplessTINT"), chance=5},
        {name=RC.getPackageItemType(".Corset_ToplessBodysuitTINT"), chance=5},
    },
