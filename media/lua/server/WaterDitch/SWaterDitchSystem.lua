...
function SWaterDitchSystem:updateSprite()
...
function SWaterDitchSystem:checkRain()
    ...
    for i=1,self:getLuaObjectCount() do
        ...
        if luaObject.waterAmount < luaObject.waterMax then
            ...
            if luaObject.exterior then
                luaObject.waterAmount = math.min(luaObject.waterMax, luaObject.waterAmount + 1 * ISWaterDitch.waterScale)
...
local function EveryTenMinutes()
	SWaterDitchSystem.instance:updateSprite()
    SWaterDitchSystem.instance:checkRain()
end
