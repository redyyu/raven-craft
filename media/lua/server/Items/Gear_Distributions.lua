...
if ProceduralDistributions.list.DrugLabGuns then 
    RC.insertDistTable(ProceduralDistributions.list.DrugLabGuns, ITEMS_WEIGHT, 1)
end
...
RC.insertDistTable(ProceduralDistributions.list.PawnShopGunsSpecial, ITEMS_WEIGHT, 1)
...
RC.insertDistTable(SuburbsDistributions.Bag_WeaponBag, ITEMS_WEIGHT, 2)
RC.insertDistTable(SuburbsDistributions.Bag_SurvivorBag, ITEMS_WEIGHT, 15)
RC.insertDistTable(SuburbsDistributions.Bag_ALICEpack, ITEMS_WEIGHT, 15)
...
RC.insertDistTable(VehicleDistributions.SurvivalistTruckBed, ITEMS_WEIGHT, 1)
...
RC.insertDistTable(VehicleDistributions.Police.TruckBed, POLICE_ITEMS_WEIGHT, 0.5)
...
RC.insertDistTable(SuburbsDistributions.Bag_ALICEpack_Army, ARMY_ITEMS_WEIGHT, 25)


RC.insertDistTable(ProceduralDistributions.list["CampingStoreGear"], 'Canteen', 0.5)
RC.insertDistTable(ProceduralDistributions.list["CampingStoreGear"], 'Canteenfull', 0.5)
