...
RC.insertDistTable(VehicleDistributions["PoliceGloveBox"], ITEMS_WEIGHT, 3)
RC.insertDistTable(VehicleDistributions["PoliceTruckBed"], ITEMS_WEIGHT, 3)

----------------------------

RC.insertDistTable(SuburbsDistributions["SurvivorCache1"]["SurvivorCrate"], ITEMS_WEIGHT, 6)
RC.insertDistTable(SuburbsDistributions["SurvivorCache2"]["SurvivorCrate"], ITEMS_WEIGHT, 6)
...
RC.insertDistTable(ProceduralDistributions.list["GunStoreAmmunition"], ITEMS_WEIGHT, 0.5)
RC.insertDistTable(ProceduralDistributions.list["GunStoreCounter"], ITEMS_WEIGHT, 0.1)
RC.insertDistTable(ProceduralDistributions.list["GunStoreShelf"], ITEMS_WEIGHT, 0.1)
