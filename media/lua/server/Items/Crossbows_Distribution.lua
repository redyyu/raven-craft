...
RC.insertDistTable(ProceduralDistributions.list["Hunter"], ITEMS_WEIGHT, 3);
RC.insertDistTable(ProceduralDistributions.list["CampingStoreBackpacks"], ITEMS_WEIGHT, 2);
RC.insertDistTable(ProceduralDistributions.list["CampingStoreGear"], ITEMS_WEIGHT, 0.5);
...
RC.insertDistTable(ProceduralDistributions.list["PawnShopGuns"], ITEMS_WEIGHT, 2.5);
